...
namespace LOGINME
{
    ...
    public sealed partial class C : Page
    {
        ...
        {
            string name = "C programming.pdf";
            string URL = "https://www.cs.rit.edu/~ats/books/ooc.pdf";
        ...
        private async void MenuFlyoutItem_Click_1(object sender, RoutedEventArgs e)
        {
            ...
            string name = " Let us C programming.pdf";
            string URL = "https://ia800402.us.archive.org/11/items/letusc_201605/let%20us%20c%20of%20yashwant%20kanetkar%2011th%20edition.pdf";
            await TestBackgroundDownloader(name, URL);
        }
        ...
        {
            string name = "Tutorialspoint C programming.pdf";
