...
namespace LOGINME
{
    ...
    /// </summary>
    public sealed partial class Python : Page
    {
        public Python()
        {
        ...
        {
            string name = "python basic programming.pdf";
            string URL = "http://www.davekuhlman.org/python_book_01.pdf";
        ...
        private async void MenuFlyoutItem_Click_1(object sender, RoutedEventArgs e)
        {
            ...
            string name = " hands on python.pdf";
            string URL = "http://www.nervenet.org/pdf/python3handson.pdf";
            await TestBackgroundDownloader(name, URL);
        }
        ...
        {
            string name = "Advanced python.pdf";
            string URL = "http://uap.unnes.ac.id/ebook/electronic%20book%201/Advanced%20Programming%20for%20the%20J/Advanced%20Java%20Programming.pdf";
            await TestBackgroundDownloader(name, URL);
        }
