...
namespace LOGINME
{
    ...
    public sealed partial class Cpp : Page
    {
        ...
        private async void diwnload_Click(object sender, RoutedEventArgs e)
        {
            ...
            string URL = "http://www.lmpt.univ-tours.fr/~volkov/C++.pdf";
        ...
        private async void MenuFlyoutItem_Click_1(object sender, RoutedEventArgs e)
        {
            ...
            string name = "C++ tutorialspoint.pdf";
            string URL = "https://www.tutorialspoint.com/cplusplus/cpp_tutorial.pdf";
            await TestBackgroundDownloader(name, URL);
        }
        ...
        {
            string name = "Advanced C++ programming.pdf";
            string URL = "http://www.cs.ukzn.ac.za/~hughm/ap/notes/apNotes.pdf";
            await TestBackgroundDownloader(name, URL);
        }
